...
export const SERVICES: Service[] = [
  {
    ...
    description: "Sesiones 1:1 a domicilio en Medellín, diseñadas para tus objetivos. Vamos a tu casa, conjunto u oficina en el Valle de Aburrá.",
    icon: Dumbbell,
  ...
  },
  {
    ...
    description: "Entrena en pareja o grupo pequeño de 2 o 3 personas, a domicilio en Medellín y el Valle de Aburrá.",
    icon: Users,
  ...
  },
  {
    ...
    description: "Evaluación completa y plan nutricional, con opción a domicilio en Medellín y el Valle de Aburrá.",
    icon: Apple,
  ...
  },
  {
    ...
    description: "Entrenamiento funcional dinámico en grupo, a domicilio en Medellín: tu conjunto, oficina o parque del Valle de Aburrá.",
    icon: Users,
  ...
  },
  {
    ...
    description: "Clases grupales llenas de energía y ritmo, a domicilio en Medellín y el Valle de Aburrá.",
    icon: Activity,
    image: "/images/clase-grupal-ritmica-medellin.webp",
  ...
  },
  {
    ...
    description: "Mejora tu resistencia y técnica con boxeo a domicilio en Medellín. Llevamos los implementos al Valle de Aburrá.",
    icon: Dumbbell,
  ...
  },
  {
    ...
    description: "Clases de natación 1:1 en piscina, presenciales en el Valle de Aburrá.",
    icon: Activity,
  ...
  },
  {
    ...
    description: "Clases de natación en grupo reducido, en piscina del Valle de Aburrá.",
    icon: Users,
    image: "/images/natacion-semi-personalizada-medellin.webp",
  ...
  },
  {
    ...
    description: "Pilates Mat a domicilio en Medellín: fortalece tu centro y mejora tu postura sin salir de casa.",
    icon: Activity,
    image: "/images/pilates-medellin.webp",
    slug: "pilates",
    atHome: true,
  ...
  },
  {
    ...
    description: "Entrenamiento 1:1 de squash en cancha, presencial en el Valle de Aburrá.",
    icon: Activity,
    image: "/images/squash-medellin.webp",
  ...
  },
  {
    ...
    description: "Entrenamiento de squash en pareja, en cancha del Valle de Aburrá.",
    icon: Users,
  ...
  },
  {
    ...
    description: "Conecta mente y cuerpo con clases de yoga a domicilio en Medellín y el Valle de Aburrá.",
    icon: Activity,
  ...
  },
  {
    ...
    description: "Recuperación, prevención y rehabilitación física con fisioterapia a domicilio en Medellín.",
    icon: Activity,
    image: "/images/fisioterapia-medellin.webp",
    slug: "fisioterapia",
    atHome: true,
  ...
  },
  {
    id: "14",
    title: "Sesión Masaje",
    description: "Masaje terapéutico y deportivo a domicilio en Medellín: relajación y recuperación muscular en tu casa.",
    icon: Activity,
